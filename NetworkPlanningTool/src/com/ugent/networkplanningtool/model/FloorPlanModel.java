...
public class FloorPlanModel extends Observable {
    ...
    /**
     * The instance used in the planning application
     */
    public static FloorPlanModel PLANNING_INSTANCE = new FloorPlanModel();

    /**
     * The instance used in the localisation application
     */
    public static FloorPlanModel LOCALISATION_INSTANCE = new FloorPlanModel();
