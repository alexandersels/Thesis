...
public abstract class FloorPlanObjectView extends LinearLayout {
	...
	public static enum ViewType{
		DRAW(PlannerActivity.getInstance().getResources().getString(R.string.drawDataObjectText)),
		EDIT(PlannerActivity.getInstance().getResources().getString(R.string.editDataObjectText)),
		INFO(PlannerActivity.getInstance().getResources().getString(R.string.infoDataObjectText));
		private String text;
